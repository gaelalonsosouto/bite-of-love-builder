...
export function ScrollBurger() {
  ...
  return (
    ...
    >
      ...
      <div
        key={entryKey}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-[12%] w-[70vw] max-w-[460px] md:w-[36vw] md:max-w-[560px] burger-drop-in"
      >
        <img
          src={BURGER_URL}
          alt=""
